...
export function setAsyncDataItemState<T>(asyncDataItem: AsyncDataItem<T>, state: AsyncDataItemState, error = ''): AsyncDataItem<T> {
    return { data: asyncDataItem.data, state, error };
}

export function wrapAsAsyncDataItem<T>(data: T, state = AsyncDataItemState.LOADING, error = ''): AsyncDataItem<T> {
...
export function queryAsyncState(asyncDataItem: AsyncDataItem<unknown>): QueryAsyncState {
    return {
...
export function getAsyncState(asyncDataItem: AsyncDataItem<unknown>): AsyncDataItemState {
